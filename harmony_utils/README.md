...
| ToastUtil .[程序员翻身].(#jump_8) | 土司工具类（promptAction）         |
...
### <a id="jump_8"></a>ToastUtil（土司工具类）[使用案例](https://gitee.com/tongyuyan/harmony-utils/blob/master/entry/src/main/ets/pages/utils/ToastUtilPage.ets)
